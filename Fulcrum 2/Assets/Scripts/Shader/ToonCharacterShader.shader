Shader "Custom/ToonCharacterShader"
{
	Properties{
		_PlayerColor("PlayerColor", Color) = (1,1,1,1)
		_Highlight("HighlightColor", Color) = (0,0,0,0)
...
#pragma fragment frag
	...
	//added for color channels
	fixed4 c = tex2D(_MainTex, input.uv);

	c.rgb = c.rgb + _Highlight * 2;

	return float4(combinedLight, 1.0) * c; // DELETE LINE COMMENTS & ';' TO ENABLE TEXTURE
